...
public class FileKit {
    ...
    public func save(file: File, withAttributes attr: [FileAttributeKey: Any]? = nil) throws -> URL {
        ...
        guard FileManager.default.createFile(atPath: file.location.path, contents: file.data, attributes: attr) == true else {
    ...
    public func create(folder: Folder, withAttributes attr: [FileAttributeKey: Any]? = nil) throws -> URL {
        do {
            try FileManager.default.createDirectory(at: folder.location, withIntermediateDirectories: true, attributes: attr)
        } catch {
    ...
    public func load(file: File) throws -> File {
        guard
            let data = FileManager.default.contents(atPath: file.location.path)
        else {
    ...
    public func load(folder: Folder) throws -> Folder {
        let fileURLs: [URL]
        do {
            fileURLs = try FileManager.default.contentsOfDirectory(at: folder.location, includingPropertiesForKeys: nil)
        } catch {
